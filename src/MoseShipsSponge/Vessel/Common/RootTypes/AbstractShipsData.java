...
public class AbstractShipsData implements ShipsData{

	public static final Object[] DATABASE_NAME = {"ShipsMeta", "Name"};
	public static final Object[] DATABASE_TYPE = {"ShipsMeta", "Type"};
	...
	public static final Object[] DATABASE_STRUCTURE = {"ShipsStructure", "BasicStructure"};
...
return map;
	...
	public List<Entity> getEntities() {
		return g_main.getExtent().getEntities().stream().filter(e -> LocationUtils.blockWorldContains(getBasicStructure(), e.getLocation().getRelative(Direction.DOWN))).collect(Collectors.toList());
	}
