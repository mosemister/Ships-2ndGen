...
/**
 * The SectionDetectedEvent will fire when a part of a ship is detected, this
 * could be a block, entity or even the whole vessel intself
 */
...
public class SectionDetectedEvent extends Event {
	...
	public static class EntityDetectedEvent extends SectionDetectedEvent {
		...
		/**
		 * this is fired when a entity is located on the ship please note this
