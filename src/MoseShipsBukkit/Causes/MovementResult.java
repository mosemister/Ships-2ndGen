...
public class MovementResult {
	...
	public static abstract class CauseKeys<T extends Object> {
		...
		public static CauseKeys<Boolean> FUEL_REMOVE_ERROR = new CauseKeys<Boolean>() {
			...
			@Override
			public void sendMessage(LiveData ship, Player player, Object value) {
		...
		public static CauseKeys<Boolean> NOT_IN_WATER = new CauseKeys<Boolean>() {
			...
			@Override
			public void sendMessage(LiveData ship, final Player player, Object value) {
		...
		public abstract void sendMessage(LiveData ship, Player player, Object value);
	}
